function scr_player_bump() {
    ...
    if (floor(image_index) == (image_number - 1))
        state = 0
    if (sprite_index != spr_player_catched && sprite_index != spr_tumbleend && sprite_index != spr_hitwall && sprite_index != spr_suplexmash1 && sprite_index != spr_suplexmash2 && sprite_index != spr_suplexmash3 && sprite_index != spr_suplexmash4 && sprite_index != spr_punch)
