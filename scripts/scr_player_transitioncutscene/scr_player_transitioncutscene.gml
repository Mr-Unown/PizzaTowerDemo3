function scr_player_transitioncutscene() {
	...
	if (sprite_index == spr_player_levelcomplete && costumercutscenetimer < 0)
	{
	    ...
	    {
	        if (collectscore >= global.srank)
	            global.rank = "s"
	        else if (collectscore > global.arank)
	            global.rank = "a"
	        else if (collectscore > global.brank)
	            global.rank = "b"
	        else if (collectscore > global.crank)
	            global.rank = "c"
	        else
	            global.rank = "d"
	        ...
	        if (room == desert_16)
	        {
	            ...
	            if (global.deserthighscore < collectscore)
	                ini_write_string("Highscore", "desert", collectscore)
	            if (global.rank == "s")
	        ...
	        {
	            ini_open("playerData_"+global.savefile+".ini")
	            if (global.mansionhighscore < collectscore)
	                ini_write_string("Highscore", "mansion", collectscore)
	        ...
	        {
	            ini_open("playerData_"+global.savefile+".ini")
	            if (global.factoryhighscore < collectscore)
	                ini_write_string("Highscore", "factory", collectscore)
	        ...
	        {
	            ini_open("playerData_"+global.savefile+".ini")
	            if (global.sewerhighscore < collectscore)
	                ini_write_string("Highscore", "sewer", collectscore)
	        ...
	        if (room == freezer_1)
	        {
	            if (global.freezerhighscore < collectscore)
	                ini_write_string("Highscore", "freezer", collectscore)
...
/* end scr_player_transitioncutscene */
}
