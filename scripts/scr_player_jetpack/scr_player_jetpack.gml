...
if (scr_solid((x + 1), y) && xscale == 1 && (!scr_slope()) && (!place_meeting((x + sign(hsp)), y, obj_slope)) && (!place_meeting((x + sign(hsp)), y, obj_metalblock)) && (!place_meeting((x + sign(hsp)), y, obj_destructibles))) 
{
jetpacking = false	
    if (fightball == 0)
    {
