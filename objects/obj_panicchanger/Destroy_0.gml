...
if (global.panic == 1 && layer_background_get_sprite(back_id6) == bg_factory1escape)
    layer_background_sprite(back_id6, bg_factory1escape)
...
if (global.panic == 1 && layer_background_get_sprite(back_id3) == bg_factory4)
    layer_background_sprite(back_id3, bg_factory4escape)
if (global.panic == 1 && layer_background_get_sprite(back_id3) == bg_factoryindustrial)
    layer_background_sprite(back_id3, bg_factoryindustrial_escape)
