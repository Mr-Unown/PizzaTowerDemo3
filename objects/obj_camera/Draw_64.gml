...
if (player.state != 55)
{
    if (player.character == "P")
    {
        ...
        if (shoving == 1)
            draw_sprite_ext(spr_pepinoHUD_shove, image_index, 125, 100, 1, 1, 0, c_white, alpha)
        ...
        else if (player.state == 69 || (player.state == "pogo" && player.pogomovespeed < 7) ||  player.state == 33 || player.state == 92 || player.state == 74 || player.state == 57 || player.state == 63 || player.state == 42 || player.state == 65 || player.state == 46 || player.state == 47 || player.state == 51 || player.state == 48 || player.state == 49 || player.state == 50)
            draw_sprite_ext(spr_pepinoHUDmach1, -1, 125, 100, 1, 1, 0, c_white, alpha)
        else if (player.state == 70 || (player.state == "pogo" && player.pogomovespeed > 7 && player.pogomovespeed < 9) || player.sprite_index == spr_player_dive || player.sprite_index == spr_player_machslideboost || player.state == 17 || player.state == 111 || player.state == 22 || player.state == 43)
        ...
        else if (player.state == "jetpack" && player.sprite_index == player.spr_jetpackcrazy)
            draw_sprite_ext(spr_pepinoHUDmach4, -1, 125, 100, 1, 1, 0, c_white, alpha)			
        else if (player.state == 91 || (player.state == "pogo" && player.pogomovespeed > 9) ||player.state == "jetpack" || player.sprite_index == spr_player_machslideboost3)
    ...
    if (player.character == "N")
    {
        ...
        if (shoving == 1)
        ...
        else if (player.state == 70 || (player.state == "pogo" && player.pogomovespeed > 7 && player.pogomovespeed < 12) || player.sprite_index == player.spr_dive || player.sprite_index == player.spr_machslideboost || player.state == 17 || player.state == 111 || player.state == 22 || player.state == 43)
            ...
            draw_sprite_ext(spr_noiseHUD_crazyrun, -1, 125, 100, 1, 1, 0, c_white, alpha)		
        else if (player.state == 91 || (player.state == "pogo" && player.pogomovespeed >= 12) || player.state == "jetpack" || player.sprite_index == player.spr_mach3boost)
    ...
    if (player.character == "V")
    {
        ...
        if (shoving == 1)
            ...
            draw_sprite_ext(spr_playerV_hurtHUD, -1, 125, 100, 1, 1, 0, c_white, alpha)
        else if (player.vigihealth < 25 && player.vigihealth != 0)
            draw_sprite_ext(spr_playerV_panicHUD, -1, 125, 100, 1, 1, 0, c_white, alpha)
        else if (player.vigihealth == 0)
            draw_sprite_ext(spr_playerV_angryHUD, -1, 125, 100, 1, 1, 0, c_white, alpha)
            ...
            draw_sprite_ext(spr_playerV_happyHUD, -1, 125, 100, 1, 1, 0, c_white, alpha)
            ...
            draw_sprite_ext(spr_playerV_machHUD, -1, 125, 100, 1, 1, 0, c_white, alpha)
        else if (player.sprite_index == spr_playerV_dive)
            draw_sprite_ext(spr_playerV_machHUD, -1, 125, 100, 1, 1, 0, c_white, alpha)
        else if (player.state == 70 || player.state == "pogo" || player.sprite_index == spr_playerV_mach2boost || player.state == 17 || player.state == 22 || player.state == 43)
            draw_sprite_ext(spr_playerV_machHUD, -1, 125, 100, 1, 1, 0, c_white, alpha)
        else if (player.state == 91 && player.sprite_index == spr_playerV_crazyrun)
            draw_sprite_ext(spr_playerV_machHUD, -1, 125, 100, 1, 1, 0, c_white, alpha)
        else if (player.state == "jetpack" && player.sprite_index == player.spr_jetpackcrazy)
            draw_sprite_ext(spr_playerV_machHUD, -1, 125, 100, 1, 1, 0, c_white, alpha)			
        else if (player.state == 91 || player.state == "jetpack" || player.sprite_index == spr_playerV_mach3boost)
            draw_sprite_ext(spr_playerV_machHUD, -1, 125, 100, 1, 1, 0, c_white, alpha)
        else if (player.state == 73 || player.sprite_index == spr_bombpep_end || player.sprite_index == spr_player_fireassend || player.state == 36 || player.state == 27 || (player.state == 54 && player.sprite_index == spr_player_bossintro) || (player.state == 54 && player.sprite_index == spr_player_idle))
            draw_sprite_ext(spr_playerV_hurtHUD, -1, 125, 100, 1, 1, 0, c_white, alpha)
            ...
            draw_sprite_ext(spr_playerV_normalHUD, -1, 125, 100, 1, 1, 0, c_white, alpha)
    }
    if (player.character == "S")
    {
        ...
        if (shoving == 1)
            ...
            draw_sprite_ext(spr_snickHUD_thunder, -1, 125, 60, 1, 1, 0, c_white, alpha)
        else if (player.sprite_index != spr_snick_robotsword && (player.state == 24 || player.state == 18))
            draw_sprite_ext(spr_snickHUD_robo, -1, 125, 60, 1, 1, 0, c_white, alpha)
        else
            draw_sprite_ext(spr_snickHUD_normal, -1, 125, 60, 1, 1, 0, c_white, alpha)
    }
    shader_reset()
    if ((player.movespeed < 2.4 || (!(player.state == 69 || player.state == 70 || player.state == 91 || player.state == "jetpack" || player.state == 17 || player.state == 71 || player.state == 37 || player.state == 12 || player.state == 111 || player.state == 22))) && player.state != "pogo") || (player.pogomovespeed <= 7 && player.state = "pogo" && player.movespeed <= 0)
        draw_sprite_ext(spr_speedbar, 0, 125, 140, 1, 1, 0, c_white, alpha)
    else if ((player.movespeed >= 2.4 && player.movespeed < 4.8 && (player.state == 69 || player.state == 70 || player.state == 91  || player.state == "jetpack" || player.state == 17 || player.state == 71 || player.state == 37 || player.state == 12 || player.state == 111 || player.state == 22)) && player.state != "pogo") || (player.pogomovespeed <= 7 && player.state = "pogo" && player.movespeed > 0)
        draw_sprite_ext(spr_speedbar, 1, 125, 140, 1, 1, 0, c_white, alpha)
    else if ((player.movespeed >= 4.8 && player.movespeed < 7.2 && (player.state == 69 || player.state == 70 || player.state == 91   || player.state == "jetpack" || player.state == 17 || player.state == 71 || player.state == 37 || player.state == 12 || player.state == 111 || player.state == 39 || player.state == 110 || player.state == 22)) && player.state != "pogo") || (player.pogomovespeed > 7 && player.state = "pogo" && player.pogomovespeed < 12)
        draw_sprite_ext(spr_speedbar, 2, 125, 140, 1, 1, 0, c_white, alpha)
    else if ((player.movespeed >= 7.2 && player.movespeed < 9.6 && (player.state == 69 || player.state == 70 || player.state == 91   || player.state == "jetpack" || player.state == 17 || player.state == 71 || player.state == 37 || player.state == 12 || player.state == 111 || player.state == 39 || player.state == 110 || player.state == 22)) && player.state != "pogo") || (player.pogomovespeed >= 12 && player.state = "pogo" && player.pogomovespeed < 14)
        draw_sprite_ext(spr_speedbar, 3, 125, 140, 1, 1, 0, c_white, alpha)
    else if ((player.movespeed >= 9.6 && player.movespeed < 12 && (player.state == 69 || player.state == 70 || player.state == 91  || player.state == "jetpack" || player.state == 17 || player.state == 71 || player.state == 37 || player.state == 12 || player.state == 111 || player.state == 39 || player.state == 110 || player.state == 22)) && player.state != "pogo") || (player.pogomovespeed >= 14 && player.state = "pogo")
        draw_sprite_ext(spr_speedbar, 4, 125, 140, 1, 1, 0, c_white, alpha)
    else if ((player.movespeed >= 12 && (player.state == 69 || player.state == 70 || player.state == 91  || player.state == "jetpack" || player.state == 17 || player.state == 71 || player.state == 37 || player.state == 12 || player.state == 111 || player.state == 22)))
