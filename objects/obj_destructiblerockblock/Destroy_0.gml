if (ds_list_find_index(global.saveroom, id) == -1)
{
    ...
    if place_meeting((x + 1), y, spr_destructiblerockblock)
    {
        with (instance_place((x + 1), y, spr_destructiblerockblock))
            alarm[1] = 8
    }
    if place_meeting((x - 1), y, spr_destructiblerockblock)
    {
    ...
    if place_meeting(x, (y + 1), spr_destructiblerockblock)
    {
        with (instance_place(x, (y + 1), spr_destructiblerockblock))
            alarm[1] = 8
    }
    if place_meeting(x, (y - 1), spr_destructiblerockblock)
    {
