...
layer_x("Backgrounds_long", (_cam_x * 0.15))
layer_y("Backgrounds_long",clamp(((_cam_y * 0.15) + longy),longy - 160,longy + 16))
layer_x("Backgrounds_3", (_cam_x * 0.05))
layer_y("Backgrounds_3", (_cam_y * 0.05))
layer_x("Backgrounds_4", (_cam_x * 0.0005))
layer_y("Backgrounds_4", (_cam_y * 0.0005))
