...
layer_x("Backgrounds_5", (_centeredcam_x * 0.95))
layer_y("Backgrounds_5", (_cam_y - clamp(_cam_y * 0.50 * (540 / room_height), 0, (sprite_get_height(layer_background_get_sprite(back_id15)) - 540 ) )))
