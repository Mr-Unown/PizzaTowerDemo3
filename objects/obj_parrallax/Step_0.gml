...
layer_y("Backgrounds_foreground",clamp(((_centeredcam_y * 0.95) +  camera_get_view_height(view_camera[0])  - sprite_get_height(layer_background_get_sprite(back_id13))  ) ,foregroundoffsety - 8,foregroundoffsety + 8))
