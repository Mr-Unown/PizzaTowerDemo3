...
if ((global.coop == 1 && playerid = obj_player2) || playerid = obj_player1) && !instance_exists(obj_fadeout)
{
    while (!ds_queue_empty(edge_indicator))
    {
        ...
        if (room != Scootertransition && room != New_Realtitlescreen && room != rank_room && room != strongcold_endscreen && room != leveltransitioncutscene && room != timesuproom && room != characterselect)
		{
